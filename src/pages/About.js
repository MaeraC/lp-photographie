    ...
    return (
        <div>
            ...
            <section className="about">
                <p><strong>LP Photographie</strong> est un studio de photographes professionnel basé à Nice. Accompagnée d'une équipe talentueuse de photographes expérimentés, notre entreprise se spécialise dans la capture d'images de haute qualité pour une variété de besoins photographiques.
                ...
                <br></br><br></br>
                <Link to="mailto:contact@lp-photographie.com"><strong>Contact : contact@lp-photographie.com</strong></Link>
            </section>
        </div>
    )
}
